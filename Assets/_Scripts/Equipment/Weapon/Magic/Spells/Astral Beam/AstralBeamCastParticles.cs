...
public class AstralBeamCastParticles : MonoBehaviour
{
    private AstralBeamSpell astralBeamSpell;
    ...
    private void Awake()
    {
        astralBeamSpell = GetComponentInParent<AstralBeamSpell>();
    ...
    private void OnEnable()
    {
        ...
        astralBeamSpell.castTrigger += playParticleSystem;

        if (usingLights) astralBeamSpell.castTrigger += turnOnLights;
    }
